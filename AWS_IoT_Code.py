...
host = "a2s3wk1pev05ot-ats.iot.us-east-1.amazonaws.com"#Replace with AWS EndPoint
rootCAPath = "rootCA.pem"#Replace the directory with your Saved Root Certificate Location
certificatePath = "bef85d5385-certificate.pem.crt"#Replace the directory with your Saved thing ertificate Location
privateKeyPath = "bef85d5385-private.pem.key"#Replace the directory with your Saved private key Location
